...
class Form extends Component {
  ...
  render() {
    ...
    {/*Please Login*/
        <p className="text-center shadow appearance-none border rounded w-full py-2 px-3 text-purple mb-6 leading-tight text-xs focus:outline-none focus:shadow-outline">
